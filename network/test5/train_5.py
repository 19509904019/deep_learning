...
加载数据集
"""
train_dataloader = DataLoader(dataset=train_set, batch_size=256, shuffle=True)
test_dataloader = DataLoader(dataset=test_set, batch_size=256, shuffle=False)
...
scheduler = lr_scheduler.StepLR(optimizer=optimizer, step_size=300, gamma=0.5)
"""
设置训练网络的一些参数
"""
# 训练的轮数
